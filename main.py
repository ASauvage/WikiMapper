...
def main(url: str, output: str, levels: int = None, road: str = None, delay: int = 0, verbose: bool = False) -> None:
    ...
    match output:
        ...
        case output if output in ('svg', 'png', 'pdf'):
...
if __name__ == '__main__':
    ...
    ap.add_argument('-o', '--output', action='store', type=str, dest='output', default='html', choices=('html', 'svg','png', 'pdf', 'json', 'csv'), help="Specify the output format")
